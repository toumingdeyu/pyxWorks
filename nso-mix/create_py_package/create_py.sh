...
then
	...
	exit 1
        ...
        NCS_SYNTAX_PACKAGE_NAME=win_act_oper_$1
fi
...
then
     ...
     sed --in-place "s/^  list /  augment \/orange:orange\/orange:win \{\n    container $NCS_SYNTAX_PACKAGE_NAME \{\n      tailf:info \"orange win $NCS_SYNTAX_PACKAGE_NAME\";\n      description \"$NCS_SYNTAX_PACKAGE_NAME package\";\n      container actions \{\n      \}\n    \}\n  \}\n\n  augment \/orange:orange\/orange:win\/$PACKAGE_NAME:$NCS_SYNTAX_PACKAGE_NAME\/$PACKAGE_NAME:actions \{\n    tailf:action $2 \{\n      tailf:actionpoint $2;\n      input \{\n        leaf device \{\n          type leafref \{\n            path \"\/ncs:devices\/ncs:device\/ncs:name\";\n          \}\n        \}\n      \}\n      output \{\n      \}\n    \}\n  \}\n\n  list /" "${YANG_FILE_TO_EDIT}"
